...
export default connect(mapStateToProps)(App); // Connect the component to the Redux store using the "connect" function and pass in the selector function to map the "objectId" prop
